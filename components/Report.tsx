...
function ShareActions({ result }: { result: ReportResult }) {
  ...
  return <div className="bottom-actions action-stack">
    ...
    <ButtonLink fullWidth href="/analyze/context">다시 분석하기</ButtonLink>
  </div>;
}
...
export default function Report() {
  ...
  if(!result)return <main className="shell"><div className="mobile-frame"><Brand/><div className="empty-result"><h1>분석 결과가 없어요.</h1><p>대화 캡처를 먼저 올려주세요.</p><ButtonLink href="/analyze/context" variant="primary">분석 시작하기</ButtonLink></div></div></main>;
